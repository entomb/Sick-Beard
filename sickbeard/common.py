...
#            return Quality.UNKNOWN
    ...
    def sceneQuality(name):
        ...
        if checkName(["(pdtv|hdtv|dsr|tvrip|web.dl|webrip).(xvid|x264|h.?264)"], all) and not checkName(["(720|1080)[pi]"], all):
            ...
            return Quality.SDDVD
        elif checkName(["720p", "hdtv", "x264"], all) or checkName(["hr.ws.pdtv.x264"], any) and not checkName(["(1080)[pi]"], all) or  checkName(["Versione 720p"], all):          
            return Quality.HDTV                                                                        
        elif checkName(["720p|1080i", "hdtv", "mpeg-?2"], all):
            return Quality.RAWHDTV                                                                     
        elif checkName(["1080p", "hdtv", "x264"], all) or checkName(["Versione 1080p"], all): 
            return Quality.FULLHDTV                                                                    
